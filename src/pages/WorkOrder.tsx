            ...
            <div className="flex justify-between items-center mb-2">
                <div className="flex items-center">
                    {workOrder.subWorkOrders &&
                        workOrder.subWorkOrders.length > 0 && (
                            <button
...
const WorkOrdersPage = () => {
    useEffect(() => {
        const fetchProjects = () => {
            axios
                .get("http://localhost:8000/dashboard/projects")
                .then((response) => {
        ...
        const fetchWorkOrders = () => {
            axios
                .get("http://localhost:8000/dashboard/workorders")
                .then((response) => {
                    console.log(response.data);
                ...
                .catch((error) => {
                    console.error(
                        "There was an error fetching the work orders!",
                        error
                    );
                });
        };
                    ...
                    <div className="col-span-9 bg-white border rounded-lg p-4">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-bold">
                                {selectedProject.name} - Work Orders
                            </h2>
